...
from ultralytics.nn.DeepCrossingAttention import DeepCrossingAttention
from ultralytics.nn.FeatureAlignModule import FeatureAlignModule
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            c1 = ch[f]
            args = [*args[1:]]
        elif m is DeepCrossingAttention:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, c2, *args[1:]]
        elif m is FeatureAlignModule:
            c1 = ch[f]
            c2 = args[0]
            args = [c1, c2, *args[1:]]
        else:
